...
public enum AuthErrorReason implements DomainErrorReason {
    ...
    NOT_REGISTERED(HttpStatus.FORBIDDEN, "AUTH403_1", "가입되지 않은 사용자입니다."),
    GITHUB_TOKEN_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH404_1", "GitHub 연동 정보를 찾을 수 없습니다."),
    GITHUB_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH404_2", "존재하지 않는 GitHub 사용자입니다."),
