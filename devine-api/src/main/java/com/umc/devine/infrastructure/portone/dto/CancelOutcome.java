 ...
 *
 * <ul>
 *   <li>{@link Succeeded} — 취소 성공(또는 이미 취소됨). 종료 처리 가능.</li>
 *   <li>{@link Rejected} — PG가 요청을 인지하고 거절. 확정 실패 → FAILED(재시도 허용).</li>
 *   <li>{@link Unknown} — 타임아웃/IO/모호한 PG 응답. 서버 상태 알 수 없음 → 절대 FAILED로 종료 금지.</li>
 * </ul>
 */
